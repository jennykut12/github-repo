...
const NoFollowers = () => {
  ...
  <h1 className='text-xl font-semibold'>No active followers</h1>
  <p className='text-xl font-semibold text-center'>You do not have any active followers currently or is not accessible.</p>
